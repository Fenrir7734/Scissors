...
public class RectangleTool extends ShapeTool {
    ...
    public RectangleTool(Canvas canvas, StackPane canvasContainer) {
    ...
    private void drawRect(GraphicsContext graphicsContext, double x, double y, double width, double height) {
        if(width < 0) {
            x += width;
            width = -width;
        }
